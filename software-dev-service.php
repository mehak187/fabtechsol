...
<script>
  ...
  gtag('config', 'G-VBDMY6M847');
    ...
    <title>Software development service - Fabulous Technology Solutions</title>
    <link rel="icon" type="image/x-icon" href="img/logo.png">
    <?php
            include 'admin/connection.php';
            $sel12 = "SELECT * FROM software_meta" or die("conn failed");
...
<body>
    <section class="services-p software-service">
        <!-- ==================================
        |            Primary nav               |
        ==================================== -->
             <?php
    ...
    <section class="primary-nav-wrapper">
        ...
        <?php
        include 'admin/connection.php';
        $sel1 = "SELECT * FROM software_hero" or die("conn failed");
            ...
            <div class="container">
                <div class="hero">
                    <div class="hero-con">
                        ...
                        <div>
                            <h6>Our Services</h6>
                            <h1><?php echo $row1['software_hero_title'] ?></h1>
                        </div>
                    </div>
                    <p><?php echo $row1['software_hero_des'] ?></p>
                </div>
            </div>
        </section>
        <?php } ?>
        ...
        ==================================== -->
        <?php
        $sel63 = "SELECT * FROM about_software" or die("conn failed");
        $res_sql63 = mysqli_query($conn,$sel63) or die("query failed");
        $row63 = mysqli_fetch_assoc($res_sql63);
        if(mysqli_num_rows($res_sql63)>0) { ?>
                ...
                <div class="about-com-main">
                    ...
                    <div class="about-img">
                        <div class="about-p-img">
                            <img src="<?php echo $row63['img_1'] ?>" alt="<?php echo $row63['heading'].'-1' ?>">
                        </div>
                        <div class="about-p-img2">
                            <img src="<?php echo $row63['img_2'] ?>" alt="<?php echo $row63['heading'].'-1' ?>">
                        </div>
                    </div>
                    <!-- ---------ABOUT-content--------- -->
                    <div class="about-content">
                        <p class="m-head">
                            ...
                            <span><?php echo $row63['heading'] ?></span>
                            <span class="arrow"><img src="img/arrow-right.png" alt="arrow-right"></span>
                        </p>
                        <h2><?php echo $row63['sub_heading'] ?></h2>
                        <p><?php echo $row63['des'] ?>
                         <!-- <a href="#"> Read more</a> -->
                        </p>
                    </div>
                </div>
        ...
        <section class="options">
            <div class="container">
                ...
                <?php 
                $select71 = "SELECT * FROM software_process";
            ...
            <div class="container">
                <div class="proced-main">
                    <div class="proced-con">
                        ...
                        <h3>How we do Software Development ?</h3>
                    </div>
                    <div class="graph">
                        <div class="graph-img">
                            <img src="img/software-graph.png" alt="graph-img">
                        </div>
