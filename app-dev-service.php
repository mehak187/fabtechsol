...
<head>
    ...
    <title>Application development service - Fabulous Technology Solutions</title>
    <link rel="icon" type="image/x-icon" href="img/logo.png">
    <?php
            include 'admin/connection.php';
            $sel12 = "SELECT * FROM app_meta" or die("conn failed");
...
<body>
    <section class="services-p software-service app-service">
        <!-- ==================================
        |            Primary nav               |
        ==================================== -->
             <?php
    ...
    <section class="primary-nav-wrapper">
        ...
        <?php
        include 'admin/connection.php';
        $sel1 = "SELECT * FROM app_hero" or die("conn failed");
            ...
            <div class="container">
                <div class="hero">
                    <div class="hero-con">
                        ...
                        <div>
                            <h6>Our Services</h6>
                            <h1><?php echo $row1['app_hero_title'] ?></h1>
                        </div>
                    </div>
                    <p><?php echo $row1['app_hero_des'] ?></p>
                </div>
            </div>
        </section>
        <?php } ?>
        ...
        ==================================== -->
        <?php
        $sel62 = "SELECT * FROM about_app" or die("conn failed");
        $res_sql62 = mysqli_query($conn,$sel62) or die("query failed");
        $row62 = mysqli_fetch_assoc($res_sql62);
        if(mysqli_num_rows($res_sql62)>0) { ?>
                ...
                <div class="about-com-main">
                    ...
                    <div class="about-img">
                        <div class="about-p-img">
                            <img src="<?php echo $row62['img_1'] ?>" alt="<?php echo $row62['heading'].'-1' ?>">
                        </div>
                        <div class="about-p-img2">
                            <img src="<?php echo $row62['img_2'] ?>" alt="<?php echo $row62['heading'].'-1' ?>">
                        </div>
                    </div>
                    <!-- ---------ABOUT-content--------- -->
                    <div class="about-content">
                        <p class="m-head">
                            ...
                            <span><?php echo $row62['heading'] ?></span>
                            <span class="arrow"><img src="img/arrow-right.png" alt="arrow-right"></span>
                        </p>
                        <h2><?php echo $row62['sub_heading'] ?></h2>
                        <p><?php echo $row62['des'] ?> 
                        <!-- <a href="#"> Read more</a> -->
                    </p>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="proced-main">
                    <div class="proced-con">
                        ...
                        <h3>How we do Application Development ?</h3>
                    </div>
                    <div class="graph">
                        <div class="graph-img">
                            <img src="img/app-graph.png" alt="graph-img">
                        </div>
                        <div class="phase app-phase-1">
                        ...
                        <div class="phase app-phase-3">
                            <h5 class="mbl-phase">Phase 3</h5>
                            <div class="phase-content">
                                <h6>Android Application</h6>
                                <ul>
                                    <li>Complete UI of App using <span>C/C++, C#, JavaScript, Python and Flutter.</span>
                                    </li>
                                    <li>Demonstration of UI Design</li>
                                </ul>
                                <div class="phase-overlay-img">
                                    <img src="img/phase-overlay-img.png" alt="overlay">
                                </div>
                        ...
                        <div class="phase app-phase-3b">
                            <div class="phase-content">
                                <h6>IOS Application</h6>
                                <ul>
                                    <li>Complete UI of App Using <span>Flutter, Objective-C and Swift.</span></li>
                                    <li>Demonstration of UI Design</li>
                                </ul>
                                <div class="phase-overlay-img">
                                    <img src="img/phase-overlay-img.png" alt="overlay">
                        ...
                        <h5 class="phase-text app-1-text">Phase 1</h5>
                        <h5 class="phase-text app-2-text">Phase 2</h5>
                        <h5 class="phase-text app-3-text">Phase 3</h5>
                        <h5 class="phase-text app-4-text">Phase 4</h5>
                        <h5 class="end">End</h5>
                    </div>
                </div>
            </div>
