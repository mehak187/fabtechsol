...
<script>
  ...
  gtag('config', 'G-VBDMY6M847');
    ...
    $res_sqlk = mysqli_query($conn, $selk);
    $rowk = mysqli_fetch_assoc($res_sqlk);
    ?>
    <!---------------og start------>
    <?php include 'og.php' ?>
    <!------------og end------------->
...
<body>
    ...
    |           Video SECTION            |
    ==================================== -->
    <div class="services-wrapper fab-video-sec">
        <div class="container">
            <div class="fab-video-main">
                <div class="course-video-main">
                    <iframe src="https://www.youtube.com/embed/PeAFYfVGL68" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>
                    <div class="video-title">
                        <h3>Intro to Command Line Interface</h3>
                    </div>
                </div>
                <div class="playlist-video-main">
                  <div class="playlist-wrapper">
                    <div class="playlist-video">
                        ...
                        <div class="video-detail">
                            <h4>What is full stack web development</h4>
