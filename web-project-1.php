...
<script>
  ...
  gtag('config', 'G-VBDMY6M847');
    ...
    <title>Project detail - Fabulous Technology Solutions</title>
    <link rel="icon" type="image/x-icon" href="img/logo.png">
    <meta name="description"
        content="Fabulous Technology Solutions project portfolio.">
       <!---------------og start------>
    <?php include 'og.php' ?>
    <!------------og end------------->
...
<body>
    ...
    <section class="primary-nav-wrapper">
       ...
       ?>
        <div class="project-det-sec">
            <div class="container">
                <div class="project-det-main">
                    <div class="project-left <?php echo $row1['p_catg'] ?>">
                        <h1 class="h4"><?php echo $row1['heading'] ?></h1>
                        <div class="project-img">
                            <img src="<?php echo $row1['icon'] ?>" alt="project-img-1">
                        </div>
                        <h5>Description</h5>
                    ...
                    <div class="project-right">
                        ...
                        <ul>
                        <?php
                            $list_item = '<li>'.' '.$row1['list_item'].'</li>';
                            ...
                            // word from which string start to break,attachment,original string
                                    $newstring = str_replace($substr, $attachment, $string,$attachment2);
                                                                 // ,        ,img, list-item
            ...
            <div class="container">
                ...
                <div class="p-gallery-main">
                    <div class="gallery-img">
                        <img src="<?php echo $row1['img_1'] ?>" alt="<?php echo $row1['img_1'] ?>">
                    </div>
                    <div class="gallery-img">
                        <img src="<?php echo $row1['img_2'] ?>" alt="<?php echo $row1['img_2'] ?>">
                    </div>
                    <div class="gallery-img">
                        <img src="<?php echo $row1['img_3'] ?>" alt="<?php echo $row1['img_3'] ?>">
                    </div>
                    <div class="gallery-img">
                        <img src="<?php echo $row1['img_4'] ?>" alt="<?php echo $row1['img_4'] ?>">
                    </div>
                   </div>
            </div>
   </div>
