...
<script>
  ...
  gtag('config', 'G-VBDMY6M847');
    ...
    <title>UI / UX design service - Fabtechsol</title>
    <link rel="icon" type="image/x-icon" href="img/logo.png">
    <?php
            include 'admin/connection.php';
            $sel12 = "SELECT * FROM ui_meta" or die("conn failed");
...
<body>
    <section class="services-p software-service ui-service">
        <!-- ==================================
        |            Primary nav               |
        ==================================== -->
            <?php
    ...
    <section class="primary-nav-wrapper">
            ...
            <div class="primary-nav">
                ...
                <div class="p-nav-left">
                    ...
                    <div class="p-nav-right">
                        <ul class="p-links">
                            <li><a href="contact-us-1">Get Hired</a></li>
        ...
        <?php
        include 'admin/connection.php';
        $sel1 = "SELECT * FROM ui_hero" or die("conn failed");
            ...
            <div class="container">
                <div class="hero">
                    <div class="hero-con">
                        ...
                        <div>
                            <h6>Our Services</h6>
                            <h1><?php echo $row1['ui_hero_title'] ?></h1>
                        </div>
                    </div>
                    <p><?php echo $row1['ui_hero_des'] ?></p>
                </div>
            </div>
        </section>
        <?php } ?>
        ...
        ==================================== -->
        <?php
        $sel61 = "SELECT * FROM about_ui" or die("conn failed");
        $res_sql61 = mysqli_query($conn,$sel61) or die("query failed");
        $row61 = mysqli_fetch_assoc($res_sql61);
        if(mysqli_num_rows($res_sql61)>0) { ?>
                ...
                <div class="about-com-main">
                    ...
                    <div class="about-img">
                        <div class="about-p-img">
                            <img src="<?php echo $row61['img_1'] ?>" alt="<?php echo $row61['heading'].'-1' ?>">
                        </div>
                        <div class="about-p-img2">
                            <img src="<?php echo $row61['img_2'] ?>" alt="<?php echo $row61['heading'].'-2' ?>">
                        </div>
                    </div>
                    <!-- ---------ABOUT-content--------- -->
                    <div class="about-content">
                        <p class="m-head">
                            ...
                            <span><?php echo $row61['heading'] ?></span>
                            <span class="arrow"><img src="img/arrow-right.png" alt="arrow-right"></span>
                        </p>
                        <h2><?php echo $row61['sub_heading'] ?></h2>
                        <p><?php echo $row61['des'] ?> 
                        <!-- <a href="#"> Read more</a> -->
                        </p>
                    </div>
                </div>
        ...
        <section class="options">
            <div class="container">
                ...
                <?php 
                $select71 = "SELECT * FROM ui_process";
            ...
            <div class="container">
                <div class="proced-main">
                    <div class="proced-con">
                        ...
                        <h3>How we do UI & UX ?</h3>
                    </div>
                    <div class="graph">
                        <div class="graph-img">
                            <img src="img/ui-graph.png" alt="graph-img">
                        </div>
                        ...
                        <div class="phase web-phase-2">
                            ...
                            <div class="phase-content">
                                <ul>
                                    ...
                                    <li>We Use Tools like <span>ADOBE XD, FIGMA, ILLUSTRATOR, PHOTOSHOP</span></li>
                                </ul>
                                <div class="phase-overlay-img">
                                    <img src="img/phase-overlay-img.png" alt="overlay">
                                </div>
