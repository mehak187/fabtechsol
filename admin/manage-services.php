    ...
    <div class="contact-details-sec">
        <div class="container">
            ...
            <?php
                ...
                <h5>Services Content</h5>
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <td><?php echo $row21['heading'] ?></td>
                                <td><?php echo $row21['sub_heading'] ?></td>
                                <td><?php echo $row21['des'] ?></td>
                                <td><a href="add-services-sec.php" class="del-can">Edit</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            if(mysqli_num_rows($res_servicem)>=1) { ?>
                ...
                <div class="contact-details-main res-tbl">
                <div class="con-det-top">
                    <h4>Add Services Box</h4>
                    <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-services-admin.php">Add Services</a>
                        </div>
                    </div>
                  </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $sr ?></td>
                                <td><?php echo $row_servicem['service_title'] ?></td>
                                <td><?php echo $row_servicem['service_des'] ?></td>
                                <td><a href="../<?php echo $row_servicem['service_link'] ?>">Link</a></td>
                                <td> <img src="../<?php echo $row_servicem['service_icon'] ?>" alt="<?php echo $row_servicem['service_title']." icon"?>"></td>
                                <td> <img src="../<?php echo $row_servicem['service_image'] ?>" alt="<?php echo $row_servicem['service_title']." service"?>"></td>
                               <td><?php echo $row_servicem['service_alt'] ?></td>
                                <td>
                                    <a href="del-service.php?id=<?php echo $row_servicem['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-service.php?id=<?php echo $row_servicem['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
