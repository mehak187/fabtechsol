   ...
   ?>
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="News" name="news" id="news" required>
                        </div>
                        <div class="field">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $date = $_POST['date'];
            $time = $_POST['time'];
            $insert_sql = "INSERT INTO news(news,date,time) Values('$news','$date','$time')" or die("conn failed");
            $res = mysqli_query($conn,$insert_sql);
            ?>
            <script>
swal("", "News added successfully","success");
</script>
        <?php }
    ?>
</body>
