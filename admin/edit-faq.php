        ...
        <div class="container">
           <?php 
            ...
            if(isset($_POST['submit'])) {
                ...
                $up_sql = "update faq set question='$question', answer='$answer' WHERE id=$faq_id" or die("query failed");
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <textarea placeholder="" name="question" id="question" required><?php echo $row1['question'] ?></textarea>
                        </div>
                       
                        <div class="field">
                            <label for="answer">Answer</label>
                            <textarea placeholder="" name="answer" id="answer" required><?php echo $row1['answer'] ?></textarea>
                        </div>
