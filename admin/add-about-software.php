...
<head>
    ...
    <title>Add about software</title>
   ...
   ?>
        ...
        <div class="container">
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add About software</h4>
                        <div class="field">
                            <label for="heading">Heading</label>
                            <input type="text" placeholder="Software Development" name="heading" id="heading" required>
                        </div>
                        <div class="field">
                            <label for="sub_heading">Sub Heading</label>
                            <input type="text" placeholder="What is Software Development in modern era." name="sub_heading" id="sub_heading" required>
                        </div>
                        <div class="field">
                            <label for="">Description</label>
                            <textarea  placeholder="FABTECHSOL Is A Global Web Design And Development Company That Provides Intelligent, Cost-Effective Web And IT Solutions. Thanks To Our Client-First Ideology, We've Gained Worldwide Recognition For The Quality Of Our Products, Services, And Solutions.FABTECHSOL Is A Global Web Design And Development Company That Provides Intelligent, Cost-Effective Web And IT Solutions. Thanks To Our Client-First Ideology, We've Gained Worldwide Recognition For The Quality Of Our Products, Services, And Solutions." name="des" id="des" required></textarea>
                        </div>
                        <div class="field">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $sel = "SELECT * FROM about_software" or die("conn failed");
            ...
            if((in_array($file_lower,$file_main)) && (in_array($file_lower2,$file_main2))) {
                ...
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update about_software set heading='$heading',sub_heading='$sub_heading',des='$des',img_1='$dest_file',img_2='$dest_file2'";
                    $res_up = mysqli_query($conn,$up);        
                    ?><script>
                    swal("", "About software content updated successfully","success");
                    </script> <?php 
                } 
                else{
                    $insert_sql = "INSERT INTO about_software(heading,sub_heading,des,img_1,img_2) Values('$heading','$sub_heading','$des','$dest_file','$dest_file2')" or die("conn failed");
                    $res = mysqli_query($conn,$insert_sql);
                    ?><script>
                    swal("", "About software content added successfully","success");
                    </script><?php
                    } 
            }
            else{
