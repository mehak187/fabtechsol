   ...
   ?>
    ...
    <div class="contact-details-sec">
        <div class="container">
            ...
            $select_servicem = "SELECT * FROM chatbot ORDER BY id DESC";
            ...
            if(mysqli_num_rows($res_servicem)>=1) { ?>
                ...
                <div class="con-det-top">
                    ...
                    <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-chatbot-qa.php">Add Chatbot Q/A</a>
                        </div>
                    </div>
                  </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $sr ?></td>
                                <td><?php echo $row_servicem['queries'] ?></td>
                                <td><?php echo $row_servicem['replies'] ?></td>
                                <td>
                                    <a href="del-chatbot.php?id=<?php echo $row_servicem['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-chatbot.php?id=<?php echo $row_servicem['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
