        ...
        <div class="container">
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Chatbot Q/A</h4>
                        
                        <div class="field">
                            <label for="service_des">Question</label>
                            <textarea  placeholder="Service Description" name="que" id="service_des" required></textarea>
                        </div>
                        <div class="field">
                            <label for="ans">Answer</label>
                            <textarea  placeholder="Service Description" name="ans" id="ans" required></textarea>
                        </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $ans =mysqli_real_escape_string($conn,$_POST['ans']);
                $insert_sql = "INSERT INTO chatbot(queries,replies) Values('$que','$ans')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "Chatbot Question added successfully","success");
                </script>
