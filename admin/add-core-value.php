            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="Integrity" name="heading" id="heading" required>
                        </div>
                        <div class="field">
                            <label for="des">Description</label>
                            <textarea placeholder="We are loyal and committed and do what is expected of us even if it takes going an extra mile." name="des" id="des" required></textarea>
                        </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $des = mysqli_real_escape_string($conn,$_POST['des']);
                $insert_sql = "INSERT INTO core_value_box(heading,des) Values('$heading','$des')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "Core value added successfully","success");
                </script>
            <?php 
            } ?>
    </body>
