            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <textarea placeholder="Question" name="question" id="question" required></textarea>
                        </div>
                        <div class="field">
                            <label for="answer">Answer</label>
                            <textarea placeholder="Answer" name="answer" id="answer" required></textarea>
                        </div>
...
<?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $answer =mysqli_real_escape_string($conn,$_POST['answer']);
                ...
                $insert_sql = "INSERT INTO faq(question,answer) Values('$question','$answer')" or die("conn failed");
