        ...
        <div class="container">
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Application Development Process</h4>
                        <div class="field">
                        ...
                        <!--        <input type="text" placeholder="List item" name="list_item[]" id="list_item" required>-->
                        <!--    </div>-->
                        <!--</div>-->
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO app_process(heading,des,icon) Values('$heading','$des','$dest_file')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "App process box added successfully","success");
                </script>
            <?php } 
            else{
                ?><script>
