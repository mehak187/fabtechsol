   ...
   ?>
    ...
    <div class="contact-details-sec">
        <div class="container">
            ...
            $select_servicem = "SELECT * FROM courses_main ORDER BY course_id DESC";
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row_servicem['course_des'] ?></td>
                                 <td> <img src="../<?php echo $row_servicem['course_image'] ?>" alt="<?php echo $row_servicem['course_title']." course"?>"></td>
                                <td>
                                    <a href="del-course.php?id=<?php echo $row_servicem['course_id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-course.php?id=<?php echo $row_servicem['course_id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
