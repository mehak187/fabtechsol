...
<head>
    ...
    <title>Add events section heading</title>
        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Events Section Content</h4>
                        <div class="field">
                            <label for="heading">Heading</label>
                            <input type="text" placeholder="Our Services" name="heading" id="heading" required>
                        </div>
        ...
        if(isset($_POST['submit'])) { 
            ...
            $row = mysqli_fetch_assoc($res_sql);
                ...
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update events_heading set heading='$heading',sub_heading='$sub_heading'";
                    ...
                    $insert_sql = "INSERT INTO events_heading(heading,sub_heading) Values('$heading','$sub_heading')" or die("conn failed");
