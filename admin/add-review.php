            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <textarea  placeholder="Client Review" name="client_para" id="client_para" required></textarea>
                        </div>
                        <div class="field">
                            <label for="client_img">Client Image</label>
                            <input type="file" name="client_img" id="client_img" required>
                            <p class="note">Recommended size:108 X 108</p>
                        </div>
                        <div class="field">
                            <label for="client_alt">Client Image Alt Tag</label>
                            <input type="text" placeholder="John Smith" name="client_img_alt" id="client_alt" required>
                        </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO client_tbl(client_name,client_img,client_para,client_img_alt) Values('$client_name','$dest_file','$client_para','$client_img_alt')" or die("conn failed");
