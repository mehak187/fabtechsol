   ...
   ?>
        ...
        <div class="container">
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add About application</h4>
                        <div class="field">
                            <label for="heading">Heading</label>
                            <input type="text" placeholder="Application Development" name="heading" id="heading" required>
                        </div>
                        <div class="field">
                            <label for="sub_heading">Sub Heading</label>
                            <input type="text" placeholder="What is Application Development in modern era." name="sub_heading" id="sub_heading" required>
                        </div>
                        <div class="field">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            $sel = "SELECT * FROM about_app" or die("conn failed");
            ...
            if((in_array($file_lower,$file_main)) && (in_array($file_lower2,$file_main2))) {
                ...
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update about_app set heading='$heading',sub_heading='$sub_heading',des='$des',img_1='$dest_file',img_2='$dest_file2'";
                    $res_up = mysqli_query($conn,$up);        
                    ?><script>
                    swal("", "About app content updated successfully","success");
                    </script> <?php 
                } 
                else{
                    $insert_sql = "INSERT INTO about_app(heading,sub_heading,des,img_1,img_2) Values('$heading','$sub_heading','$des','$dest_file','$dest_file2')" or die("conn failed");
                    $res = mysqli_query($conn,$insert_sql);
                    ?><script>
                    swal("", "About app content added successfully","success");
                    </script><?php
                    } 
            }
            else{
