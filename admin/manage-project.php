    ...
    <div class="contact-details-sec">
        <div class="container">
            <?php
                ...
                $sel64 = "SELECT * FROM about_project" or die("conn failed");
                ...
                <div class="contact-details-main res-tbl">
                    ...
                    <h4>Manage About Section - Project Page</h4>
                </div>    
                    <table class="table">
                        <thead>
                            <tr>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><?php echo $row64['btn_name'] ?></td>
                                <td><a href="<?php echo $row64['btn_link'] ?>"> <?php echo $row64['btn_link'] ?></a></td>
                                <td><img src="../<?php echo $row64['img_1'] ?>" alt="<?php echo $row64['heading'].'-1' ?>"></td>
                                <td><a href="add-about-project" class="del-can">Edit</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <?php
            include 'connection.php';
            $select71 = "SELECT * FROM project_portfolio order by p_catg DESC";
            $res71 = mysqli_query($conn,$select71);
            if(mysqli_num_rows($res71)>=1) { ?>
                <div class="contact-details-main res-tbl">
                <div class="con-det-top">
                <h4>Manage Projects Portfolio</h4>
                <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-project" target="_blank">Add Projects</a>
                        </div>
                </div>
            </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?php echo $row71['sub_heading'] ?></td>
                                <td><?php echo $row71['des'] ?></td>
                                <td><?php echo $row71['p_catg'] ?></td>
                                <td><?php echo $row71['list_item'] ?></td>
                                <td> <img src="<?php echo $row71['icon'] ?>" alt="icon"></td>
                                
                                <td>
                                    <a href="del-project?id=<?php echo $row71['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-project?id=<?php echo $row71['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
