...
// ----------add-about-----
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM  events_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update events_hero set event_hero_title='$hero_title',event_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO events_hero(event_hero_title,event_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
