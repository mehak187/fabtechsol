...
<meta charset="UTF-8">
    ...
    <title>Manage technologies admin</title>
    ...
    <div class="contact-details-sec">
        <div class="container">
            <div class="con-det-top">
                <h4>Admin Technology</h4>
                <div class="blue-btns-main">
                    <div class="blue-btn">
                        <a href="add-technology.php">Add Technology</a>
                    </div>
                </div>
            </div>
            <?php
            include 'connection.php';
            $sel11 = "SELECT * FROM tech_tbl ORDER BY id DESC" or die("conn failed");
                ...
                <div class="contact-details-main res-tbl">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $sr = 1;
                                while($row11 = mysqli_fetch_assoc($res_sql11)) { ?>
                            <tr>
                                <td><?php echo $sr ?></td>
                                <td><?php echo $row11['tech_name'] ?></td>
                                <td> <img src="../<?php echo $row11['tech_img'] ?>" alt="<?php echo $row11['tech_name'] ?>"></td>
                                <td>
                                    <a href="del-technology.php?id=<?php echo $row11['id'] ?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-technology.php?id=<?php echo $row11['id'] ?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
