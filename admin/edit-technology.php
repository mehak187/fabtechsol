    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "select * FROM tech_tbl where id = $id2";
            ...
            if(isset($_POST['submit'])) {
                ...
                if(in_array($file_lower,$file_main)){
                    ...
                    $up_sql = "update tech_tbl set tech_name='$tech_name', tech_img='$dest_file' WHERE id=$tech_id" or die("query failed");
                    $res = mysqli_query($conn,$up_sql);
                    ?>
                    <script>window.location="https://fabtechsol.com/admin/manage-technologies.php";</script>
                    <?php
                    $_SESSION['EDIT'] = "hey2";
                } 
                else{
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div>
                            <input type="hidden" placeholder="" name="tech_id" id="tech_id" value="<?php echo $row1['id'] ?>" required>
                        </div>

                        <div class="field">
                            <label for="tech_name">Technology Name</label>
                            <input type="text" placeholder="" name="tech_name" id="tech_name" value="<?php echo $row1['tech_name'] ?>" required>
                        </div>
                       
                        <div class="field">
                            <label for="tech_img">Technology Image</label>
                            <input type="file" name="tech_img" id="tech_img" required>
                             <p class="note">Recommended size:62 X 60</p>
                        </div>
