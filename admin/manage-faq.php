   ...
   ?>
    ...
    <div class="contact-details-sec">
        <div class="container">
            ...
            $select_faq = "SELECT * FROM faq ORDER BY id ASC";
            $res_faq = mysqli_query($conn,$select_faq); 
            if(mysqli_num_rows($res_faq)>=1) { ?>
                ...
                <div class="contact-details-main res-tbl">
                    <table class="table">
                        ...
                        <tbody>
                            <?php
                                $sr = 1;
                                while($row_faq = mysqli_fetch_assoc($res_faq)) { ?>
                            <tr>
                                <td><?php echo $sr ?></td>
                                <td><?php echo $row_faq['question'] ?></td>
                                <td><?php echo $row_faq['answer'] ?></td>
                                <td>
                                    <a href="del-faq.php?id=<?php echo $row_faq['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-faq.php?id=<?php echo $row_faq['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
