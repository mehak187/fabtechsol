    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "SELECT * FROM project_portfolio where id = $id2";
                ...
                $file4 = $_FILES['img_4'];
                    ...
                    if(!empty($file['name'])) {
                       ...
                       $file_main = array('jpg','png','jpeg');
                             if (in_array($file_lower, $file_main)) {
                                 ...
                                 $up_img = "update project_portfolio set icon='$dest_file' WHERE id=$ser_id" or die("update failed");
                                 $res_img = mysqli_query($conn,$up_img);
                    ...
                    if(!empty($file1['name'])) {
                        ...
                        if (in_array($file_lower1, $file_main1)) {
                            ...
                            $up_img1 = "update project_portfolio set img_1='$dest_file1' WHERE id=$ser_id" or die("update failed");
                           $res_img1 = mysqli_query($conn,$up_img1);
                        } 
                        else{ ?>
                            <script>
                                swal("", "Invalid File Format", "error");
                    ...
                    if(!empty($file2['name'])) {
                        ...
                        if (in_array($file_lower2, $file_main2)) {
                            ...
                            $up_img2 = "update project_portfolio set img_2='$dest_file2' WHERE id=$ser_id" or die("update failed");
                            $res_img2 = mysqli_query($conn,$up_img2);
                     ...
                     if(!empty($file3['name'])) {
                        ...
                        if (in_array($file_lower3, $file_main3)) {
                           ...
                           $up_img3 = "update project_portfolio set img_3='$dest_file3' WHERE id=$ser_id" or die("update failed");
                           $res_img3 = mysqli_query($conn,$up_img3);
                        } 
                        else{ ?>
                            <script>
                                swal("", "Invalid File Format", "error");
                      ...
                      if(!empty($file4['name'])) {
                        ...
                        if (in_array($file_lower4, $file_main4)) {
                             ...
                             move_uploaded_file($file_tmp4, $dest_file4);
                              $up_img4 = "update project_portfolio set img_4='$dest_file4' WHERE id=$ser_id" or die("update failed");
                            $res_img4 = mysqli_query($conn,$up_img4);
                        } 
                        else{ ?>
                            <script>
                                swal("", "Invalid File Format", "error");
                    ...
                    $up_sql = "update project_portfolio set heading='$heading',sub_heading='$sub_heading', des='$des', list_item='$list_item', p_catg='$p_catg' WHERE id=$ser_id" or die("query failed");
                    $res = mysqli_query($conn,$up_sql);
                    ?>
                    <script>window.location="https://fabtechsol.com/admin/manage-project.php";</script>
                    <?php
                    $_SESSION['EDIT'] = "hey2";
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Edit Web Service Process</h4>
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="" value="<?php echo $row1['sub_heading'] ?>" name="sub_heading" id="sub_heading" required>
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <p class="note">Recommended size:370 X 220</p>
                        </div>
                         <div class="field">
                        ...
                        <div class="add-list" id="dup-sec">
                            <div class="field" id="dup-con">
                                ...
                                <input type="text" placeholder="Add list item" name="list_item[]" id="list_item" value="<?php echo $row1['list_item'] ?>">
                            </div>
                        </div>
                        <div class="add-more" id="dup-btn">
                          ...
                          <h5>More images</h5>
                         <div class="field">
                            <label for="img_1">Image</label>
                            <input type="file" name="img_1" id="img_1">
                            <p class="note">Recommended size:600 X 600</p>
                        </div>
                        <div class="field">
                            <label for="img_2">Image</label>
                            <input type="file" name="img_2" id="img_2">
                            <p class="note">Recommended size:600 X 600</p>
                        </div>
                        <div class="field">
                            <label for="img_3">Image</label>
                            <input type="file" name="img_3" id="img_3">
                            <p class="note">Recommended size:600 X 600</p>
                        </div>
                        <div class="field">
                            <label for="img_4">Image</label>
