...
<head>
    ...
    <title>Edit quality policy</title>
    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "SELECT * FROM quality_policy where id = $id2";
            ...
            if(isset($_POST['submit'])) {
                ...
                $up_sql = "update quality_policy set des='$des' WHERE id=$tech_id" or die("query failed");
