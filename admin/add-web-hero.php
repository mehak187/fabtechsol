...
<head>
    ...
    <title>Add Website Development-Hero Section</title>
        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Website Development-Hero Section</h4>
                        <div class="field">
...
<?php
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM web_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update web_hero set web_hero_title='$hero_title',web_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO web_hero(web_hero_title,web_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
