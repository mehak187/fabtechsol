...
<head>
    ...
    <title>Add Application Development-Hero Section</title>
        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Application Development-Hero Section</h4>
                        <div class="field">
...
<?php
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM app_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update app_hero set app_hero_title='$hero_title',app_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO app_hero(app_hero_title,app_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
