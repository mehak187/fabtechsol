            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="course Title" name="course_title" id="course_title" required>
                        </div>
                        <div class="field">
                            <label for="course_des">course Description</label>
                            <textarea  placeholder="course Description" name="course_des" id="course_des" required></textarea>
                        </div>
                        <div class="field">
                            <label for="course_image">course Image</label>
                            <input type="file" name="course_image" id="course_image" required>
                        </div>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower2,$file_main2)){
                ...
                $insert_sql = "INSERT INTO courses_main(course_title,course_des,course_image) Values('$course_title','$course_des','$dest_file2')" or die("conn failed");
