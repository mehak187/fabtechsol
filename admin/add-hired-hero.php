...
<head>
    ...
    <title>Add get hired hero</title>
        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Get Hired Hero Section</h4>
                        <div class="field">
                        ...
                        <div class="field">
                            <label for="hero_des">Hero Description (optional)</label>
                            <textarea placeholder="Hero Paragraph" name="hero_des" id="hero_des"></textarea>
                        </div>
...
// ----------add-about-----
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM hired_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update hired_hero set hired_hero_title='$hero_title',hired_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO hired_hero(hired_hero_title,hired_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
