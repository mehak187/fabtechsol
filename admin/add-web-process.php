    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO web_process(heading,des,icon) Values('$heading','$des','$dest_file')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "Web process box added successfully","success");
                </script>
            <?php } 
            else{
                ?><script>
