...
<head>
    ...
    <title>Add Software Process</title>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO software_process(heading,des,icon) Values('$heading','$des','$dest_file')" or die("conn failed");
