...
<meta charset="UTF-8">
    ...
    <title>Manage Software Service</title>
    ...
    <div class="contact-details-sec">
        <div class="container">
            <div class="con-det-top">
                <h4>Software Development Service</h4>
            </div>

            <!-- -------service text-------- -->
            <?php
                include 'connection.php';
                $sel64 = "SELECT * FROM about_software" or die("conn failed");
                ...
                <h5>Software Service About Section</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Heading</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="add-about-software.php" class="del-can">Edit</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            if(mysqli_num_rows($res71)>=1) { ?>
                ...
                <div class="con-det-top">
                    ...
                    <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-software-process.php">Add Software Process</a>
                        </div>
                    </div>
            </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="del-software-process.php?id=<?php echo $row71['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-software-process?id=<?php echo $row71['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
