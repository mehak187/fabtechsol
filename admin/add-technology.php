            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="Technology Name" name="tech_name" id="tech_name" required>
                        </div>
                        <div class="field">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO tech_tbl(tech_name,tech_img) Values('$tech_name','$dest_file')" or die("conn failed");
