    ...
    <div class="contact-details-sec">
        <div class="container">
            <div class="con-det-top">
                <h4>Courses Registration Form Details</h4>
            </div>
            <!-- -----filters------ -->
                <?php
                include('connection.php');
                // -----Without filter---
                $select_contact = "SELECT * FROM course_form ORDER BY id DESC";
                            ...
                            <tbody>
                                ...
                                while ($row3 = mysqli_fetch_assoc($res3)) { ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php echo $row3['st_time'] ?> - 
                                            <?php echo $row3['end_time'] ?>
                                        </td>
                                        <td>
                                            <?php echo $row3['days'] ?>
                                        </td>
                                        ...
                                        <td>
                                            <a href="del-courses-form.php?id=<?php echo $row3['id']; ?>" class="del-can">Delete
                                            </a>
                                        </td>
