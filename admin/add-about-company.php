   ...
   ?>
    ...
    <div class="contact-details-sec contact-us-sec">
        ...
        include 'connection.php';
         $sel = "SELECT * FROM about_company" or die("conn failed");
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <textarea name="des" id="des" required><?php echo $row['des'] ?></textarea>
                        </div>
                        <div class="field">
                            <label for="btn_name">Button Name</label>
                            <input type="text" placeholder="Let's begin" name="btn_name" id="btn_name" value="<?php echo $row['btn_name'] ?>" required>
                        </div>
                        <div class="field">
                            <label for="btn_link">Button Link (only page name)</label>
                            <input type="text" placeholder="contact-us" name="btn_link" id="btn_link" value="<?php echo $row['btn_link'] ?>" required>
                        </div>
                        <div class="field">
                            <label for="img_1">Image 1</label>
                            <input type="file" name="img_1" id="img_1" required>
                            <p class="note">Recommended size:412 X 334</p>
                        </div>
                        <div class="field">
        ...
        if(isset($_POST['submit'])) {
            ...
            if((in_array($file_lower,$file_main)) && (in_array($file_lower2,$file_main2))) {
                ...
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update about_company set heading='$heading',sub_heading='$sub_heading',des='$des',btn_name='$btn_name',btn_link='$btn_link',img_1='$dest_file',img_2='$dest_file2'";
                    ...
                    $insert_sql = "INSERT INTO about_company(heading,sub_heading,des,btn_name,btn_link,img_1,img_2) Values('$heading','$sub_heading','$des','$btn_name','$btn_link','$dest_file','$dest_file2')" or die("conn failed");
