...
<head>
    ...
    <title>Add Software Development-Hero Section</title>
        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Software Development-Hero Section</h4>
                        <div class="field">
                        ...
                        <div class="field">
                            <label for="hero_des">Hero Description</label>
                            <textarea placeholder="Hero Paragraph" name="hero_des" id="hero_des" required></textarea>
                        </div>
...
<?php
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM software_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update software_hero set software_hero_title='$hero_title',software_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO software_hero(software_hero_title,software_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
