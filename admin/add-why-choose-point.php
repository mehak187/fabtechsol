...
<head>
    ...
    <title>Add why choose points</title>
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO why_fab_points(point_name,icon) Values('$point_name','$dest_file')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "Point added successfully","success");
                </script>
            <?php 
            }
            else{
