...
<meta charset="UTF-8">
    ...
    <title>Manage web Service</title>
    ...
    <div class="contact-details-sec">
        <div class="container">
            <div class="con-det-top">
                <h4>Website Development Service</h4>
            </div>
            ...
            <?php
                ...
                <h5>Web Service About Section</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Heading</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="add-about-web.php" class="del-can">Edit</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            <?php
            include 'connection.php';
            $select71 = "SELECT * FROM web_process";
            $res71 = mysqli_query($conn,$select71);
            if(mysqli_num_rows($res71)>=1) { ?>
                <div class="contact-details-main res-tbl">
                <div class="con-det-top">
                    <h4>Website Development Process</h4>
                    <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-web-process.php">Add Website Process</a>
                        </div>
                    </div>
            </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="del-web-process.php?id=<?php echo $row71['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-web-process?id=<?php echo $row71['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
