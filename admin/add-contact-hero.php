        ...
        <div class="container">
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add Contact-Hero Section</h4>
                        <div class="field">
...
// ----------add-about-----
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM contact_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update contact_hero set contact_hero_title='$hero_title',contact_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO contact_hero(contact_hero_title,contact_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
