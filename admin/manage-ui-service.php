...
<meta charset="UTF-8">
    ...
    <title>Manage UI/UX Service</title>
    ...
    <div class="contact-details-sec">
        <div class="container">
            <div class="con-det-top">
                <h4>UI/UX Designing Service</h4>
            </div>

            <!-- -------service text-------- -->
            <?php
                include 'connection.php';
                $sel64 = "SELECT * FROM about_ui" or die("conn failed");
                ...
                <h5>UI/UX Service About Section</h5>
                    <table class="table">
                        <thead>
                            <tr>
                                <th>Heading</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><a href="add-about-ui.php" class="del-can">Edit</a></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
            ...
            if(mysqli_num_rows($res71)>=1) { ?>
                <div class="contact-details-main res-tbl">
                <div class="con-det-top">
                    <h4>UI/UX Designing Process</h4>
                    <div class="blue-btns-main">
                        <div class="blue-btn">
                            <a href="add-ui-process.php">Add UI/UX Process</a>
                        </div>
                    </div>
            </div>
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="del-ui-process.php?id=<?php echo $row71['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-ui-process?id=<?php echo $row71['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
