        ...
        <div class="container">
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Add UI/UX Design Process</h4>
                        <div class="field">
    ...
    <?php
        ...
        if(isset($_POST['submit'])) {
            ...
            if(in_array($file_lower,$file_main)){
                ...
                $insert_sql = "INSERT INTO ui_process(heading,des,icon) Values('$heading','$des','$dest_file')" or die("conn failed");
                $res = mysqli_query($conn,$insert_sql);
                ?><script>
                swal("", "UI/UX process box added successfully","success");
                </script>
            <?php } 
            else{
                ?><script>
