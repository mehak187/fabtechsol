        ...
        <div class="container">
            <div class="con-det-top">
                ...
                <div class="blue-btns-main">
                    <div class="blue-btn">
                        <a href="add-work-flow.php">Add Workflow</a>
                    </div>
                </div>
            </div>
            <?php
            ...
            if(mysqli_num_rows($res_workflow)>=1) { ?>
                ...
                <div class="contact-details-main res-tbl">
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><?php echo $sr ?></td>
                                <td><?php echo $row_workflow ['heading'] ?></td>
                                <td><?php echo $row_workflow ['des'] ?></td>
                                <td> <img src="../<?php echo $row_workflow['icon'] ?>" alt="workflow-<?php echo $sr ?>"></td>
                                <td>
                                    <a href="del-work-flow.php?id=<?php echo $row_workflow['id'];?>" class="del-can">Delete
                                        </a>
                                </td>
                                <td>
                                    <a href="edit-work-flow.php?id=<?php echo $row_workflow['id'];?>" class="del-can">Edit
                                        </a>
                                </td>
                            </tr>
                            <?php $sr++; } ?>
