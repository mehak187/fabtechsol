    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "select * FROM chatbot where id = $id2";
            ...
            if(isset($_POST['submit'])) {
                ...
                $ser_id = $_POST['ser_id'];
                    $up_sql = "update chatbot set queries='$que', replies='$ans' WHERE id=$ser_id" or die("query failed");
                    $res = mysqli_query($conn,$up_sql);
                    ?>
                    <script>window.location="https://fabtechsol.com/admin/manage-chatbot.php";</script>
                    <?php
                    $_SESSION['EDIT'] = "hey2";
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            <label for="service_des">Questions</label>
                            <textarea  placeholder="" name="que" id="service_des"><?php echo $row1['queries'] ?></textarea>
                        </div>
                        <div class="field">
                            <label for="service_des">Answers</label>
                            <textarea  placeholder="" name="ans" id="service_des"><?php echo $row1['replies'] ?></textarea>
                        </div>
