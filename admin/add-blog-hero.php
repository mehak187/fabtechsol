...
// ----------add-about-----
        ...
        if(isset($_POST['submit'])) { 
            ...
            $sel = "SELECT * FROM blog_hero" or die("conn failed");
            $res_sql = mysqli_query($conn,$sel);
            $row = mysqli_fetch_assoc($res_sql);
            
                if(mysqli_num_rows($res_sql)>0) {
                    $up = "update blog_hero set blog_hero_title='$hero_title',blog_hero_des='$hero_des'";
                    ...
                    $insert_sql = "INSERT INTO blog_hero(blog_hero_title,blog_hero_des) Values('$hero_title','$hero_des')" or die("conn failed");
