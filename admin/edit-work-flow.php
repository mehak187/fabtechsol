    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "select * FROM work_flow where id = $id2";
            ...
            if(isset($_POST['submit'])) {
                ...
                if(in_array($file_lower,$file_main)){
                    ...
                    $up_sql = "update work_flow set heading='$heading', des='$des', icon='$dest_file' WHERE id=$ser_id" or die("query failed");
                    $res = mysqli_query($conn,$up_sql);
                    ?>
                    <script>window.location="https://fabtechsol.com/admin/manage-work-flow.php";</script>
                    <?php
                    $_SESSION['EDIT'] = "hey2";
                } 
                else{
                ...
                <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <div class="field">
                            ...
                            <input type="text" placeholder="" name="heading" id="heading" value="<?php echo $row1['heading'] ?>" required>
                        </div>
                        <div class="field">
                        ...
                        <div class="field">
                            ...
                            <p class="note">Recommended size:30 X 30</p>
                        </div>
