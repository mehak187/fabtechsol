...
<head>
    ...
    <title>Edit UI/UX process</title>
    ...
    <div class="contact-details-sec contact-us-sec">
        <div class="container">
           <?php 
             ...
             $id2 = $_GET['id'];
             $sql = "SELECT * FROM ui_process where id = $id2";
            ...
            if(isset($_POST['submit'])) {
                ...
                if(in_array($file_lower,$file_main)){
                    ...
                    $up_sql = "update ui_process set heading='$heading', des='$des', icon='$dest_file' WHERE id=$ser_id" or die("query failed");
                    $res = mysqli_query($conn,$up_sql);
                    ?>
                    <script>window.location="https://fabtechsol.com/admin/manage-ui-service.php";</script>
                    <?php
                    $_SESSION['EDIT'] = "hey2";
                } 
                else{
            ...
            <div class="add-news">
                    <form action="<?php echo htmlentities($_SERVER['PHP_SELF']); ?>" method="POST"
                        ...
                        <h4>Edit UI/UX Service Process</h4>
